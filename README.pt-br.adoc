...
É possível executar todos os testes, ou selectionar testes específicos, para serem executados. Utilizando o Maven, para executar o teste BRStateTest, por exemplo, esse é o comando:

----
$ mvn surefire:test -Dtest=com.example.JavaProject.BRStateTest test
----

Como ele é um teste unitário (`BRState` é apenas um enumerado) esse teste executará bem rapidamente.
...
==== Listagem das cidades por nome

----
$ ./scripts/client.sh br-cities-search-findByName Trindade
{
  "_embedded" : {
    "br-cities" : [ {
      "state" : "GO",
      ...
      "_links" : {
        "self" : {
          "href" : "http://localhost:8080/br-cities/7"
        },
        "br-city" : {
          "href" : "http://localhost:8080/br-cities/7"
        }
      ...
      "_links" : {
        "self" : {
          "href" : "http://localhost:8080/br-cities/8"
        },
        "br-city" : {
          "href" : "http://localhost:8080/br-cities/8"
        }
  ...
  "_links" : {
    "self" : {
      "href" : "http://localhost:8080/br-cities/search/findByName?name=Trindade"
    }
  }
}
----
